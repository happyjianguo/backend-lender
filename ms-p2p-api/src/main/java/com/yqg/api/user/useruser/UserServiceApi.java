...
public class UserServiceApi {
    ...
    public static final String path_userAuthBankInfoBySession = "/api-user/user/userAuthBankInfoBySession";        //session查询用户实名绑卡状态
    ...
    public static final String path_resetPayPassword = "/api-user/users/resetPayPassword";        //重置交易密码

    public static final String path_uploadHeadImage = "/api-user/users/uploadHeadImage";        //上传头像图片
    ...
    public static final String path_messageList = "/api-user/users/getMessageList";        //通知消息列表

    public static final String path_updateUserMessage = "/api-user/users/updateUserMessage";        //通知消息标记已读
