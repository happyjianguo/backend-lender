...
public class OrderOrderServiceApi {
    ...
    public static final String path_healthcheck = "/api-order/healthcheck";
    ...
    public static final String path_addAllToCart = "/public/api-order/shoppingCart/addAll";
    public static final String path_getShoppingCartList = "/public/api-order/shoppingCart/getList";
    public static final String path_getCartCount = "/public/api-order/shoppingCart/getCartCount";
    ...
    public static final String path_addListGoodsForShoppingCart = "/public/api-order/shoppingCart/addList";
    ...
    public static final String path_selectUsrOrderList = "/public/api-order/order/selectUsrOrderList";//查询用户订单记录

    public static final String path_selectUsrOrderListControl = "/api-order/order/selectUsrOrderList";//查询用户订单记录
//    public static final String path_selectUsrOrderSize = "/api-order/order/selectUsrOrderSize";//查询用户订单笔数
    ...
    public static final String path_orderSubmit = "/public/api-order/order/orderSubmit";     //提交订单
    public static final String path_sendDigisign = "/public/api-order/order/sendDigisign";     //提交订单
    public static final String path_signOrder = "/public/api-order/order/signOrder";
    public static final String path_checkDigisign = "/public/api-order/order/checkDigisign";
    public static final String path_orderPay = "/public/api-order/order/orderPay";     //订单支付
    public static final String path_checkPayPWD = "/public/api-order/order/checkPayPWD";
    ...
    public static final String path_selectOrderDetail = "/public/api-order/order/selectOrderDetail";
    public static final String path_selectOrderDetailControl = "/api-order/order/selectOrderDetail";


    //查询散标列表
    public static final String path_select_ScatterstandardList = "/public/api-order/scatterStandard/selectScatterstandardList";
    //查询散标详情
    public static final String path_select_scatterstandard_by_id = "/public/api-order/scatterStandard/selectScatterstandardById";

    public static final String path_selectLoanHistory = "/public/api-order/scatterStandard/selectLoanHistory";//查询历史借款记录
    ...
    public static final String path_getRepayRate = "/public/api-order/order/getRepayRate";//查询回款率
