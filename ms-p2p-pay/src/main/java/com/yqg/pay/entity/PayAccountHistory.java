...
//资金入方id
    ...
    public static final String paychannel_field="paychannel";
    ...
    public static final String buildTime_field="buildTime";

    //支付时间
    private String payTime;
    public static final String payTime_field="payTime";

    //订单号
    private String dealStatus;
    public static final String dealStatus_field="dealStatus";
}
