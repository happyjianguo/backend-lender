...
public enum BaseExceptionEnums implements IExceptionEnum {
    ...
    UPLOAD_SAVE_ERROR(-13,"文件存储失败,请稍后再试……", "Penyimpanan file gagal, Silakan coba lagi nanti"),
    ...
    SERVICE_CALL_ERROR(-16,"服务调用异常", "Pemanggilan layanan eror"),
    ...
    TASK_NO_FUND_ERROR(-20,"任务不存在,请检查任务编号","Task tidak ada, Periksa kembali nomor Task" ),
