...
import com.yqg.common.log.formatter.Formatter;
...
/**
 * Created by gao on 2017/9/9.
 */
@Component
public class KafkaMongoAppender extends AppenderBase<ILoggingEvent> {

    private static final Logger log = LoggerFactory.getLogger(KafkaMongoAppender.class);
    ...
    public void start() {
        ...
        try {
            ...
            props.put("ro.timeout.ms",  timeout);
            props.put("metadata.fetch.timeout.ms",  timeout);
            props.put("network.ro.timeout.ms",  timeout);
