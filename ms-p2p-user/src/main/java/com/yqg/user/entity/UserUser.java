...
public class UserUser extends BaseEntity implements Serializable{
    ...
    public static final String payPwd_field="payPwd";

    //身份证图片
    private String idCardImage;
    public static final String idCardImage_field="idCardImage";

    //头像图片
    private String headImage;
    public static final String headImage_field="headImage";
    //认证失败原因
