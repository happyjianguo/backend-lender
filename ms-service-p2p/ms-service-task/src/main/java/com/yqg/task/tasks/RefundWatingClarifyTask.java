 ...
 */
@Component
public class RefundWatingClarifyTask extends AbstractTask {

    @Autowired
    private OrderTaskService orderTaskService;

    public RefundWatingClarifyTask() {
    ...
    public void runTask(Object taskData)  {
        logger.info("还款清分watting定时任务:" + taskData);
        try {
            orderTaskService.refundWating();
