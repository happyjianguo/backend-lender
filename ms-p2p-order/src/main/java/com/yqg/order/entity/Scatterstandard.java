...
//实际还款时间
    ...
    public static final String limitCount_field="limitCount";
    private String preCreditorNo;
    public static final String preCreditorNo_field="preCreditorNo";
    ...
    public static final String extensionStatus_field="extensionStatus";
}
